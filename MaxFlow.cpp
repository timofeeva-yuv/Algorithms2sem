...
long long DFS(Net& net, const vector<size_t>& layers, size_t vertex, vector<size_t>& edgeIterators,
...
vector<size_t> BuildLayeredNetwork (const Net& net) {
    ...
    // Заполняем максимальными значениями, чтобы понимать, если до вершины не дойти
